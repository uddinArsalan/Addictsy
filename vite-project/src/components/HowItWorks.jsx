...
const Work = () => {
  return (
    <div id="howitworks">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 md:gap-4 gap-8 mt-8">
          <div className="flex flex-col items-center">
            <div className="p-12 rounded-full bg-white w-16 relative mb-3">
              <div className="text-white flex items-center justify-center font-semibold rounded-full bg-bullets absolute top-0 left-0 w-6">1</div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-white flex items-center justify-center font-semibold rounded-full bg-bullets absolute top-0 left-0 w-6">2</div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-white flex items-center justify-center font-semibold rounded-full bg-bullets absolute top-0 left-0 w-6">3</div>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-white flex items-center justify-center font-semibold rounded-full bg-bullets absolute top-0 left-0 w-6">4</div>
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#006492" fillOpacity="1" d="M0,64L80,74.7C160,85,320,107,480,122.7C640,139,800,149,960,144C1120,139,1280,117,1360,106.7L1440,96L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>
    </div>
  );
};
